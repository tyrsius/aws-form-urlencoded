...
describe("formurlencoded.encode", function() {
  ...
  it("should return encoded data, with object properties", function() {
    ...
    ).toBe('propStr1=str1&propStr2=str2&propObj1.objPropStr1=objStr1&propObj1.objPropStr2=objStr2');
  });
  ...
  it("should return the correct test result", function() {
    var formurlencoded = require('../aws-form-urlencoded');
    var obj = {
      str: 'val',
      num: 0,
  ...
  it("should not return encoded empty array", function() {
    expect(
      formurlencoded({
        emptyArr: []
      })
